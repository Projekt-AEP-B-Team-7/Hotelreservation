...
class HotelManager:
    ...
    def read_available_hotels_by_guest_capacity(self, city: str, check_in_date: str, check_out_date: str, guest_count: int) -> list[Hotel]:
        return self.__hotel_da.read_available_hotels_by_guest_capacity(city, check_in_date, check_out_date, guest_count)

    def read_available_hotels(self, city: str, int, check_in_date: str, check_out_date: str) -> list[Hotel]:
