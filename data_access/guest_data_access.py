...
class GuestDataAccess(BaseDataAccess):
    ...
    def create_new_guest(self, first_name: str, last_name: str, email: str, address: Address = None) -> Guest:
        ...
        """
        params = (first_name, last_name, email, None, address.address_id if address else None)
        last_row_id, row_count = self.execute(sql, params)
        return Guest(last_row_id, first_name, last_name, email, None, address)
    ...
    def create_new_guest_w_phone_nr(self, first_name: str, last_name: str, email: str, phone_number: str, address: Address = None) -> Guest:
        ...
        INSERT INTO Guest (first_name, last_name, email, phone_number, address_id) VALUES (?, ?, ?, ?, ?)
        """
        params = (first_name, last_name, email, phone_number, address.address_id if address else None)
        last_row_id, row_count = self.execute(sql, params)
        return Guest(last_row_id, first_name, last_name, email, phone_number, address)
    ...
    def read_guest_by_id(self, guest_id: int) -> Guest | None:
        ...
        if result:
            guest_id, first_name, last_name, email, phone_number, address_id, street, city, zip_code = result
            address = None
            if address_id:
                address = Address(address_id, street, city, zip_code)
            return Guest(guest_id, first_name, last_name, email, phone_number, address)
        else:
            return None
    ...
    def update_guest(self, guest: Guest) -> None:
        ...
        WHERE guest_id = ?
        """
        params = tuple([guest.first_name, guest.last_name, guest.email, guest.phone_number,
